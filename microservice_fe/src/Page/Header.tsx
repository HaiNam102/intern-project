...
const Header = (): JSX.Element => {
  const [isLoggedIn, setIsLoggedIn] = useState<boolean>(false); // Thêm state quản lý đăng nhập
  const [showDropdown, setShowDropdown] = useState<boolean>(false); // State để điều khiển dropdown
